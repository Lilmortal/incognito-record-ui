export default {
  ...
  aboutMeContent: {
    ...
    defaultMessage: `
    Hey all, my name is Jack. This website is made from scratch by me to showcase my progression towards being a competent full stack developer. I will be showcasing what I have learnt so far, as well as detailing what do I still need to improve on. 
  ...
  whyAmIDoingThisContent: {
    ...
    defaultMessage: `
    I am severely suffering (lol, suffering may be the wrong word here) from imposter syndrome. There are still some basic concepts that I do not yet fully understand.`
  },
  ...
  howAmIGoingToAchieveThisContent: {
    ...
    defaultMessage: `
    I will be posting what I have learnt, and what project I am currently doing that will help support this. Large companies typically conduct interviews where you are expected to think out loud.
